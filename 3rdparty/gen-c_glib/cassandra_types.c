...
column_finalize (GObject *object)
{
  ...
  {
    g_byte_array_free (tobject->name, TRUE);
    tobject->name = NULL;
  }
  if (tobject->value != NULL)
  {
    g_byte_array_free (tobject->value, TRUE);
    tobject->value = NULL;
  }
}
...
super_column_write (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  ...
  xfer += ret;
  {
    ...
    xfer += ret;
    guint i1;
    for (i1=0; i1<this_object->columns->len; i1++)
    {
      if ((ret = thrift_struct_write (THRIFT_STRUCT ((g_ptr_array_index ((GPtrArray *) this_object->columns, i1))), protocol, error)) < 0)
        return -1;
      xfer += ret;
...
super_column_finalize (GObject *object)
{
  ...
  {
    g_ptr_array_free (tobject->columns, TRUE);
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              CounterColumn * _elem2 = NULL;
              if ( _elem2 != NULL)
              {
                g_object_unref (_elem2);
              }
              _elem2 = g_object_new (TYPE_COUNTER_COLUMN, NULL);
              ...
              xfer += ret;
              g_ptr_array_add (this_object->columns, _elem2);
            }
            if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
              return -1;
            xfer += ret;
...
counter_super_column_write (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  ...
  xfer += ret;
  {
    ...
    xfer += ret;
    guint i3;
    for (i3=0; i3<this_object->columns->len; i3++)
    {
      if ((ret = thrift_struct_write (THRIFT_STRUCT ((g_ptr_array_index ((GPtrArray *) this_object->columns, i3))), protocol, error)) < 0)
        return -1;
      xfer += ret;
...
column_or_super_column_finalize (GObject *object)
{
  ...
  if (tobject->super_column != NULL)
  {
    g_object_unref(tobject->super_column);
    tobject->super_column = NULL;
  }
  if (tobject->counter_column != NULL)
  {
    g_object_unref(tobject->counter_column);
    tobject->counter_column = NULL;
  }
  if (tobject->counter_super_column != NULL)
  {
    g_object_unref(tobject->counter_super_column);
    tobject->counter_super_column = NULL;
  }
}
  ...
  while (1)
  {
    ...
    switch (fid)
    {
      case 3:
        if (ftype == T_STRING)
        {
          if (this_object->column_family != NULL)
          {
            g_free(this_object->column_family);
            this_object->column_family = NULL;
          }
      ...
      case 4:
        if (ftype == T_STRING)
        {
          if (this_object->super_column != NULL)
          {
            g_free(this_object->super_column);
            this_object->super_column = NULL;
          }
...
column_parent_finalize (GObject *object)
{
  ...
  /* satisfy -Wall in case we don't use tobject */
  THRIFT_UNUSED_VAR (tobject);
  if (tobject->column_family != NULL)
  {
    g_free (tobject->column_family);
    tobject->column_family = NULL;
  }
  if (tobject->super_column != NULL)
  {
    g_free (tobject->super_column);
    tobject->super_column = NULL;
  }
}
...
column_path_finalize (GObject *object)
{
  ...
  if (tobject->super_column != NULL)
  {
    g_byte_array_unref(tobject->super_column);
    tobject->super_column = NULL;
  }
  if (tobject->column != NULL)
  {
    g_byte_array_unref(tobject->column);
    tobject->column = NULL;
  }
}
  ...
  while (1)
  {
    ...
    switch (fid)
    {
      case 1:
        if (ftype == T_STRING)
        {
          if (this_object->start != NULL)
          {
            g_free(this_object->start);
            this_object->start = NULL;
          }
      ...
      case 2:
        if (ftype == T_STRING)
        {
          if (this_object->finish != NULL)
          {
            g_free(this_object->finish);
            this_object->finish = NULL;
          }
...
slice_range_finalize (GObject *object)
{
  ...
  {
    g_free (tobject->start);
    tobject->start = NULL;
  }
  if (tobject->finish != NULL)
  {
    g_free (tobject->finish);
    tobject->finish = NULL;
  }
}
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              ...
              g_free (data);
              g_ptr_array_add (this_object->column_names, _elem4);
            }
            if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
              return -1;
            xfer += ret;
...
slice_predicate_write (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  ...
  if (this_object->__isset_column_names == TRUE) {
    ...
    xfer += ret;
    {
      ...
      xfer += ret;
      guint i5;
      for (i5=0; i5<this_object->column_names->len; i5++)
      {
        if ((ret = thrift_protocol_write_binary (protocol, ((GByteArray *) ((gchar*)g_ptr_array_index ((GPtrArray *) this_object->column_names, i5)))->data, ((GByteArray *) ((gchar*)g_ptr_array_index ((GPtrArray *) this_object->column_names, i5)))->len, error)) < 0)
          return -1;
      }
      if ((ret = thrift_protocol_write_list_end (protocol, error)) < 0)
        return -1;
...
void slice_predicate_instance_init(SlicePredicate * object) {
    /* satisfy -Wall */
    THRIFT_UNUSED_VAR(object);
    object->column_names = g_ptr_array_new_with_free_func(gDestroyNotify);
...
slice_predicate_finalize (GObject *object)
{
  ...
  /* satisfy -Wall in case we don't use tobject */
  THRIFT_UNUSED_VAR (tobject);
  if (tobject->column_names != NULL)
  {
    g_ptr_array_free (tobject->column_names, TRUE);
    tobject->column_names = NULL;
  }
  if (tobject->slice_range != NULL)
  {
    g_object_unref(tobject->slice_range);
    tobject->slice_range = NULL;
  }
}
      ...
      case 2:
        if (ftype == T_I32)
        {
          ...
          if ((ret = thrift_protocol_read_i32 (protocol, &ecast6, error)) < 0)
            return -1;
          xfer += ret;
          this_object->op = (IndexOperator)ecast6;
          isset_op = TRUE;
        } else {
          if ((ret = thrift_protocol_skip (protocol, ftype, error)) < 0)
            return -1;
...
index_expression_finalize (GObject *object)
{
  ...
  {
    g_byte_array_unref (tobject->column_name);
    tobject->column_name = NULL;
  }
  if (tobject->value != NULL)
  {
    g_byte_array_unref (tobject->value);
    tobject->value = NULL;
  }
}
  ...
  while (1)
  {
    ...
    switch (fid)
    {
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              IndexExpression * _elem7 = NULL;
              if ( _elem7 != NULL)
              {
                g_object_unref (_elem7);
              }
              _elem7 = g_object_new (TYPE_INDEX_EXPRESSION, NULL);
              ...
              xfer += ret;
              g_ptr_array_add (this_object->expressions, _elem7);
            }
            if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
              return -1;
            xfer += ret;
      ...
      case 2:
        if (ftype == T_STRING)
        {
          if (this_object->start_key != NULL)
          {
            g_free(this_object->start_key);
            this_object->start_key = NULL;
          }
...
index_clause_write (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  ...
  xfer += ret;
  {
    ...
    xfer += ret;
    guint i8;
    for (i8=0; i8<this_object->expressions->len; i8++)
    {
      if ((ret = thrift_struct_write (THRIFT_STRUCT ((g_ptr_array_index ((GPtrArray *) this_object->expressions, i8))), protocol, error)) < 0)
        return -1;
      xfer += ret;
...
index_clause_instance_init (IndexClause * object)
{
  /* satisfy -Wall */
  THRIFT_UNUSED_VAR (object);
  object->expressions = g_ptr_array_new_with_free_func (g_object_unref);
...
index_clause_finalize (GObject *object)
{
  ...
  /* satisfy -Wall in case we don't use tobject */
  THRIFT_UNUSED_VAR (tobject);
  if (tobject->expressions != NULL)
  {
    g_ptr_array_free (tobject->expressions, TRUE);
    tobject->expressions = NULL;
  }
  if (tobject->start_key != NULL)
  {
    g_byte_array_free (tobject->start_key, TRUE);
    tobject->start_key = NULL;
  }
}
  ...
  while (1)
  {
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == T_STRING)
        {
          if (this_object->end_key != NULL)
          {
            g_free(this_object->end_key);
            this_object->end_key = NULL;
          }
      ...
      case 3:
        if (ftype == T_STRING)
        {
          if (this_object->start_token != NULL)
          {
            g_free(this_object->start_token);
            this_object->start_token = NULL;
          }
      ...
      case 4:
        if (ftype == T_STRING)
        {
          if (this_object->end_token != NULL)
          {
            g_free(this_object->end_token);
            this_object->end_token = NULL;
          }
...
key_range_finalize (GObject *object)
{
  ...
  if (tobject->start_key != NULL)
  {
    g_free (tobject->start_key);
    tobject->start_key = NULL;
  }
  if (tobject->end_key != NULL)
  {
    g_free (tobject->end_key);
    tobject->end_key = NULL;
  }
  if (tobject->start_token != NULL)
  {
    g_free (tobject->start_token);
    tobject->start_token = NULL;
  }
  if (tobject->end_token != NULL)
  {
    g_free (tobject->end_token);
    tobject->end_token = NULL;
  }
}
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              ColumnOrSuperColumn * _elem9 = NULL;
              if ( _elem9 != NULL)
              {
                g_object_unref (_elem9);
              }
              _elem9 = g_object_new (TYPE_COLUMN_OR_SUPER_COLUMN, NULL);
...
key_slice_write (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  ...
  xfer += ret;
  {
    ...
    xfer += ret;
    guint i10;
    for (i10=0; i10<this_object->columns->len; i10++)
    {
      if ((ret = thrift_struct_write (THRIFT_STRUCT ((g_ptr_array_index ((GPtrArray *) this_object->columns, i10))), protocol, error)) < 0)
        return -1;
      xfer += ret;
...
key_slice_finalize (GObject *object)
{
  ...
  if (tobject->key != NULL)
  {
    g_byte_array_free (tobject->key, TRUE);
    tobject->key = NULL;
  }
  if (tobject->columns != NULL)
  {
...
mutation_finalize (GObject *object)
{
  ...
  /* satisfy -Wall in case we don't use tobject */
  THRIFT_UNUSED_VAR (tobject);
  if (tobject->column_or_supercolumn != NULL)
  {
    g_object_unref(tobject->column_or_supercolumn);
    tobject->column_or_supercolumn = NULL;
  }
  if (tobject->deletion != NULL)
  {
    g_object_unref(tobject->deletion);
    tobject->deletion = NULL;
  }
}
  ...
  while (1)
  {
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == T_STRING)
        {
          if (this_object->datacenter != NULL)
          {
            g_free(this_object->datacenter);
            this_object->datacenter = NULL;
          }
      ...
      case 3:
        if (ftype == T_STRING)
        {
          if (this_object->rack != NULL)
          {
            g_free(this_object->rack);
            this_object->rack = NULL;
          }
...
endpoint_details_finalize (GObject *object)
{
  ...
  if (tobject->datacenter != NULL)
  {
    g_free (tobject->datacenter);
    tobject->datacenter = NULL;
  }
  if (tobject->rack != NULL)
  {
    g_free (tobject->rack);
    tobject->rack = NULL;
  }
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              ...
              if ((ret = thrift_protocol_read_string (protocol, &_elem11, error)) < 0)
                return -1;
              xfer += ret;
              g_ptr_array_add (this_object->endpoints, _elem11);
            }
            if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
              return -1;
            xfer += ret;
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              ...
              if ((ret = thrift_protocol_read_string (protocol, &_elem12, error)) < 0)
                return -1;
              xfer += ret;
              g_ptr_array_add (this_object->rpc_endpoints, _elem12);
            }
            if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
              return -1;
            xfer += ret;
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              EndpointDetails * _elem13 = NULL;
              if ( _elem13 != NULL)
              {
                g_object_unref (_elem13);
              }
              _elem13 = g_object_new (TYPE_ENDPOINT_DETAILS, NULL);
              ...
              xfer += ret;
              g_ptr_array_add (this_object->endpoint_details, _elem13);
            }
            if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
              return -1;
            xfer += ret;
...
token_range_write (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  ...
  xfer += ret;
  {
    ...
    xfer += ret;
    guint i14;
    for (i14=0; i14<this_object->endpoints->len; i14++)
    {
      if ((ret = thrift_protocol_write_string (protocol, ((gchar*)g_ptr_array_index ((GPtrArray *) this_object->endpoints, i14)), error)) < 0)
        return -1;
    }
    if ((ret = thrift_protocol_write_list_end (protocol, error)) < 0)
      return -1;
  ...
  if (this_object->__isset_rpc_endpoints == TRUE) {
    ...
    xfer += ret;
    {
      ...
      xfer += ret;
      guint i15;
      for (i15=0; i15<this_object->rpc_endpoints->len; i15++)
      {
        if ((ret = thrift_protocol_write_string (protocol, ((gchar*)g_ptr_array_index ((GPtrArray *) this_object->rpc_endpoints, i15)), error)) < 0)
          return -1;
      }
      if ((ret = thrift_protocol_write_list_end (protocol, error)) < 0)
        return -1;
  ...
  if (this_object->__isset_endpoint_details == TRUE) {
    ...
    xfer += ret;
    {
      ...
      xfer += ret;
      guint i16;
      for (i16=0; i16<this_object->endpoint_details->len; i16++)
      {
        if ((ret = thrift_struct_write (THRIFT_STRUCT ((g_ptr_array_index ((GPtrArray *) this_object->endpoint_details, i16))), protocol, error)) < 0)
          return -1;
        xfer += ret;
...
token_range_instance_init (TokenRange * object)
{
  ...
  object->start_token = NULL;
  object->end_token = NULL;
  object->endpoints = g_ptr_array_new_with_free_func (g_free);
  object->rpc_endpoints = g_ptr_array_new_with_free_func (g_free);
  object->__isset_rpc_endpoints = FALSE;
  object->endpoint_details = g_ptr_array_new_with_free_func (g_object_unref);
...
token_range_finalize (GObject *object)
{
  ...
  {
    g_ptr_array_free (tobject->endpoints, TRUE);
    tobject->endpoints = NULL;
  }
  if (tobject->rpc_endpoints != NULL)
  {
    g_ptr_array_free (tobject->rpc_endpoints, TRUE);
    tobject->rpc_endpoints = NULL;
  }
  if (tobject->endpoint_details != NULL)
  {
    g_ptr_array_free (tobject->endpoint_details, TRUE);
    tobject->endpoint_details = NULL;
  }
}
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              ...
              if ((ret = thrift_protocol_read_string (protocol, &val18, error)) < 0)
                return -1;
              xfer += ret;
              g_hash_table_insert ((GHashTable *)this_object->credentials, (gpointer) key17, (gpointer) val18);
            }
...
authentication_request_instance_init (AuthenticationRequest * object)
{
  /* satisfy -Wall */
  THRIFT_UNUSED_VAR (object);
  object->credentials = g_hash_table_new_full (g_str_hash, g_str_equal, g_free, g_free);
}
...
authentication_request_finalize (GObject *object)
{
  ...
  /* satisfy -Wall in case we don't use tobject */
  THRIFT_UNUSED_VAR (tobject);
  if (tobject->credentials != NULL)
  {
    g_hash_table_destroy (tobject->credentials);
    tobject->credentials = NULL;
  }
}
  ...
  while (1)
  {
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == T_STRING)
        {
          if (this_object->validation_class != NULL)
          {
            g_free(this_object->validation_class);
            this_object->validation_class = NULL;
          }
      ...
      case 3:
        if (ftype == T_I32)
        {
          ...
          if ((ret = thrift_protocol_read_i32 (protocol, &ecast19, error)) < 0)
            return -1;
          xfer += ret;
          this_object->index_type = (IndexType)ecast19;
      ...
      case 4:
        if (ftype == T_STRING)
        {
          if (this_object->index_name != NULL)
          {
            g_free(this_object->index_name);
            this_object->index_name = NULL;
          }
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              ...
              if ((ret = thrift_protocol_read_string (protocol, &val21, error)) < 0)
                return -1;
              xfer += ret;
              g_hash_table_insert ((GHashTable *)this_object->index_options, (gpointer) key20, (gpointer) val21);
            }
...
column_def_instance_init (ColumnDef * object)
{
  ...
  object->index_options = g_hash_table_new_full (g_str_hash, g_str_equal, g_free, g_free);
...
column_def_finalize (GObject *object)
{
  ...
  if (tobject->validation_class != NULL)
  {
    g_free (tobject->validation_class);
    tobject->validation_class = NULL;
  }
  if (tobject->index_name != NULL)
  {
    g_free (tobject->index_name);
    tobject->index_name = NULL;
  }
  if (tobject->index_options != NULL)
  {
    g_hash_table_destroy (tobject->index_options);
    tobject->index_options = NULL;
  }
}
  ...
  while (1)
  {
    ...
    switch (fid)
    {
      case 1:
        if (ftype == T_STRING)
        {
          if (this_object->keyspace != NULL)
          {
            g_free(this_object->keyspace);
            this_object->keyspace = NULL;
          }
      ...
      case 3:
        if (ftype == T_STRING)
        {
          if (this_object->column_type != NULL)
          {
            g_free(this_object->column_type);
            this_object->column_type = NULL;
          }
      ...
      case 5:
        if (ftype == T_STRING)
        {
          if (this_object->comparator_type != NULL)
          {
            g_free(this_object->comparator_type);
            this_object->comparator_type = NULL;
          }
      ...
      case 6:
        if (ftype == T_STRING)
        {
          if (this_object->subcomparator_type != NULL)
          {
            g_free(this_object->subcomparator_type);
            this_object->subcomparator_type = NULL;
          }
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              ColumnDef * _elem22 = NULL;
              if ( _elem22 != NULL)
              {
                g_object_unref (_elem22);
              }
              _elem22 = g_object_new (TYPE_COLUMN_DEF, NULL);
              ...
              xfer += ret;
              g_ptr_array_add (this_object->column_metadata, _elem22);
            }
            if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
              return -1;
            xfer += ret;
      ...
      case 15:
        if (ftype == T_STRING)
        {
          if (this_object->default_validation_class != NULL)
          {
            g_free(this_object->default_validation_class);
            this_object->default_validation_class = NULL;
          }
      ...
      case 26:
        if (ftype == T_STRING)
        {
          if (this_object->key_validation_class != NULL)
          {
            g_free(this_object->key_validation_class);
            this_object->key_validation_class = NULL;
          }
      ...
      case 27:
        if (ftype == T_STRING)
        {
          if (this_object->row_cache_provider != NULL)
          {
            g_free(this_object->row_cache_provider);
            this_object->row_cache_provider = NULL;
          }
      ...
      case 28:
        if (ftype == T_STRING)
        {
          if (this_object->key_alias != NULL)
          {
            g_free(this_object->key_alias);
            this_object->key_alias = NULL;
          }
      ...
      case 29:
        if (ftype == T_STRING)
        {
          if (this_object->compaction_strategy != NULL)
          {
            g_free(this_object->compaction_strategy);
            this_object->compaction_strategy = NULL;
          }
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              ...
              if ((ret = thrift_protocol_read_string (protocol, &key23, error)) < 0)
                return -1;
              xfer += ret;
              if (val24 != NULL)
              {
              ...
              if ((ret = thrift_protocol_read_string (protocol, &val24, error)) < 0)
                return -1;
              xfer += ret;
              g_hash_table_insert ((GHashTable *)this_object->compaction_strategy_options, (gpointer) key23, (gpointer) val24);
            }
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              ...
              if ((ret = thrift_protocol_read_string (protocol, &val26, error)) < 0)
                return -1;
              xfer += ret;
              g_hash_table_insert ((GHashTable *)this_object->compression_options, (gpointer) key25, (gpointer) val26);
            }
...
cf_def_write (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  ...
  if (this_object->__isset_column_metadata == TRUE) {
    ...
    xfer += ret;
    {
      ...
      xfer += ret;
      guint i27;
      for (i27=0; i27<this_object->column_metadata->len; i27++)
      {
        if ((ret = thrift_struct_write (THRIFT_STRUCT ((g_ptr_array_index ((GPtrArray *) this_object->column_metadata, i27))), protocol, error)) < 0)
          return -1;
        xfer += ret;
...
cf_def_instance_init (CfDef * object)
{
  ...
  object->name = NULL;
  object->column_type = g_strdup ("Standard");
  object->__isset_column_type = FALSE;
  object->comparator_type = g_strdup ("BytesType");
  ...
  object->column_metadata = g_ptr_array_new_with_free_func (g_object_unref);
  ...
  object->compaction_strategy_options = g_hash_table_new_full (g_str_hash, g_str_equal, g_free, g_free);
  ...
  object->compression_options = g_hash_table_new_full (g_str_hash, g_str_equal, g_free, g_free);
...
cf_def_finalize (GObject *object)
{
  ...
  /* satisfy -Wall in case we don't use tobject */
  THRIFT_UNUSED_VAR (tobject);
  if (tobject->keyspace != NULL)
  {
    g_free (tobject->keyspace);
    tobject->keyspace = NULL;
  }
  if (tobject->name != NULL)
  {
    g_free (tobject->name);
  ...
  if (tobject->column_type != NULL)
  {
    g_free (tobject->column_type);
    tobject->column_type = NULL;
  }
  if (tobject->comparator_type != NULL)
  {
    g_free (tobject->comparator_type);
    tobject->comparator_type = NULL;
  }
  if (tobject->subcomparator_type != NULL)
  {
    g_free (tobject->subcomparator_type);
    tobject->subcomparator_type = NULL;
  }
  ...
  if (tobject->column_metadata != NULL)
  {
    g_ptr_array_free (tobject->column_metadata, TRUE);
    tobject->column_metadata = NULL;
  }
  if (tobject->default_validation_class != NULL)
  {
    g_free (tobject->default_validation_class);
    tobject->default_validation_class = NULL;
  }
  if (tobject->key_validation_class != NULL)
  {
    g_free (tobject->key_validation_class);
    tobject->key_validation_class = NULL;
  }
  if (tobject->row_cache_provider != NULL)
  {
    g_free (tobject->row_cache_provider);
    tobject->row_cache_provider = NULL;
  }
  if (tobject->key_alias != NULL)
  {
    g_free (tobject->key_alias);
    tobject->key_alias = NULL;
  }
  if (tobject->compaction_strategy != NULL)
  {
    g_free (tobject->compaction_strategy);
    tobject->compaction_strategy = NULL;
  }
  if (tobject->compaction_strategy_options != NULL)
  {
    g_hash_table_destroy (tobject->compaction_strategy_options);
    tobject->compaction_strategy_options = NULL;
  }
  if (tobject->compression_options != NULL)
  {
    g_hash_table_destroy (tobject->compression_options);
    tobject->compression_options = NULL;
  }
}
  ...
  while (1)
  {
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == T_STRING)
        {
          if (this_object->strategy_class != NULL)
          {
            g_free(this_object->strategy_class);
            this_object->strategy_class = NULL;
          }
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              ...
              if ((ret = thrift_protocol_read_string (protocol, &val29, error)) < 0)
                return -1;
              xfer += ret;
              g_hash_table_insert ((GHashTable *)this_object->strategy_options, (gpointer) key28, (gpointer) val29);
            }
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              ...
              _elem30 = g_object_new (TYPE_CF_DEF, NULL);
              ...
              xfer += ret;
              g_ptr_array_add (this_object->cf_defs, _elem30);
            }
            if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
              return -1;
            xfer += ret;
...
ks_def_write (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  ...
  xfer += ret;
  {
    ...
    xfer += ret;
    guint i31;
    for (i31=0; i31<this_object->cf_defs->len; i31++)
    {
      if ((ret = thrift_struct_write (THRIFT_STRUCT ((g_ptr_array_index ((GPtrArray *) this_object->cf_defs, i31))), protocol, error)) < 0)
        return -1;
      xfer += ret;
...
ks_def_instance_init (KsDef * object)
{
  ...
  object->strategy_options = g_hash_table_new_full (g_str_hash, g_str_equal, g_free, g_free);
  object->__isset_strategy_options = FALSE;
  object->replication_factor = 0;
  object->__isset_replication_factor = FALSE;
  object->cf_defs = g_ptr_array_new_with_free_func (g_object_unref);
...
ks_def_finalize (GObject *object)
{
  ...
  if (tobject->strategy_class != NULL)
  {
    g_free (tobject->strategy_class);
    tobject->strategy_class = NULL;
  }
  if (tobject->strategy_options != NULL)
  {
    g_hash_table_destroy (tobject->strategy_options);
    tobject->strategy_options = NULL;
  }
  if (tobject->cf_defs != NULL)
  {
    g_ptr_array_free (tobject->cf_defs, TRUE);
    tobject->cf_defs = NULL;
  }
}
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              ...
              _elem32 = g_object_new (TYPE_COLUMN, NULL);
...
cql_row_write (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  ...
  xfer += ret;
  {
    ...
    xfer += ret;
    guint i33;
    for (i33=0; i33<this_object->columns->len; i33++)
    {
  ...
  while (1)
  {
    ...
    switch (fid)
    {
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              ...
              if ((ret = thrift_protocol_read_binary (protocol, &data, &len, error)) < 0)
                return -1;
              xfer += ret;
              key34 = g_byte_array_new();
              g_byte_array_append (key34, (guint8 *) data, (guint) len);
              g_free (data);
              if (val35 != NULL)
              {
                g_free(val35);
              ...
              if ((ret = thrift_protocol_read_string (protocol, &val35, error)) < 0)
                return -1;
              xfer += ret;
              g_hash_table_insert ((GHashTable *)this_object->name_types, (gpointer) key34, (gpointer) val35);
            }
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              ...
              if ((ret = thrift_protocol_read_string (protocol, &val37, error)) < 0)
                return -1;
              xfer += ret;
              g_hash_table_insert ((GHashTable *)this_object->value_types, (gpointer) key36, (gpointer) val37);
            }
      ...
      case 3:
        if (ftype == T_STRING)
        {
          if (this_object->default_name_type != NULL)
          {
            g_free(this_object->default_name_type);
            this_object->default_name_type = NULL;
          }
      ...
      case 4:
        if (ftype == T_STRING)
        {
          if (this_object->default_value_type != NULL)
          {
            g_free(this_object->default_value_type);
            this_object->default_value_type = NULL;
          }
...
cql_metadata_instance_init (CqlMetadata * object)
{
  /* satisfy -Wall */
  THRIFT_UNUSED_VAR (object);
  object->name_types = g_hash_table_new_full (g_str_hash, g_str_equal, g_free, g_free);
  object->value_types = g_hash_table_new_full (g_str_hash, g_str_equal, g_free, g_free);
...
cql_metadata_finalize (GObject *object)
{
  ...
  /* satisfy -Wall in case we don't use tobject */
  THRIFT_UNUSED_VAR (tobject);
  if (tobject->name_types != NULL)
  {
    g_hash_table_destroy (tobject->name_types);
    tobject->name_types = NULL;
  }
  if (tobject->value_types != NULL)
  {
    g_hash_table_destroy (tobject->value_types);
    tobject->value_types = NULL;
  }
  if (tobject->default_name_type != NULL)
  {
    g_free (tobject->default_name_type);
    tobject->default_name_type = NULL;
  }
  if (tobject->default_value_type != NULL)
  {
    g_free (tobject->default_value_type);
    tobject->default_value_type = NULL;
  }
}
      ...
      case 1:
        if (ftype == T_I32)
        {
          ...
          if ((ret = thrift_protocol_read_i32 (protocol, &ecast38, error)) < 0)
            return -1;
          xfer += ret;
          this_object->type = (CqlResultType)ecast38;
          isset_type = TRUE;
        } else {
          if ((ret = thrift_protocol_skip (protocol, ftype, error)) < 0)
            return -1;
        ...
        {
          {
            ...
            for (i = 0; i < size; i++)
            {
              ...
              _elem39 = g_object_new (TYPE_CQL_ROW, NULL);
              ...
              xfer += ret;
              g_ptr_array_add (this_object->rows, _elem39);
            }
            if ((ret = thrift_protocol_read_list_end (protocol, error)) < 0)
              return -1;
            xfer += ret;
...
cql_result_write (ThriftStruct *object, ThriftProtocol *protocol, GError **error)
{
  ...
  if (this_object->__isset_rows == TRUE) {
    ...
    xfer += ret;
    {
      ...
      xfer += ret;
      guint i40;
      for (i40=0; i40<this_object->rows->len; i40++)
      {
        if ((ret = thrift_struct_write (THRIFT_STRUCT ((g_ptr_array_index ((GPtrArray *) this_object->rows, i40))), protocol, error)) < 0)
          return -1;
        xfer += ret;
...
cql_result_finalize (GObject *object)
{
  ...
  {
    g_ptr_array_free (tobject->rows, TRUE);
    tobject->rows = NULL;
  }
